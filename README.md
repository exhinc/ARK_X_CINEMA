...
The narration stage converts the approved recap script into spoken audio.

The current master contains the Piper TTS engine and the resumable TTS stage adapter. Real production execution, voice quality, timing, and resource use remain subject to Windows validation.

The architecture is modular so the narration implementation can evolve without redesigning the movie-intelligence pipeline.
...
The current master contains the deterministic edit-manifest engine, FFmpeg video engine, and resumable video-stage adapter. Real production rendering, playback, and media quality remain subject to Windows validation.
...
The current Stage-A composition path is:

```text
Engine/stage_a_runner.py
```

The current master contains the repository-side Stage-A composition through TTS, video assembly, and final QA. Real execution of those external/runtime components and complete end-to-end production remain subject to Windows validation.
...
- [x] Repository-side Piper TTS implementation and stage adapter
- [x] Repository-side scene-selection/edit-manifest implementation
- [x] Repository-side FFmpeg video implementation and stage adapter
- [x] Repository-side final narration subtitle generation
- [x] Repository-side automated final-media QA adapter/inspector
- [ ] Complete movie-intelligence runtime validation
- [ ] Complete narration runtime validation
- [ ] Complete scene-selection/edit runtime validation
- [ ] Complete FFmpeg production rendering validation
- [ ] Final end-to-end test movie
