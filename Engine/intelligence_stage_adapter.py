...
def run_intelligence_stage(
    ...
    *,
    ...
    The adapter deliberately accepts an inference callable so unit tests never
    require Ollama. Production callers use the real local Ollama adapter.
    """
    ...
    run_existing_stage(root, movie_id, "intelligence", work, artifact=str(artifact).replace("\\", "/"))
