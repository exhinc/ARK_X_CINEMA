...
def _timeline():
    return {
        "scenes": [{
            ...
            "sources": ["subtitle", "ad"],
            "cues": [
                {"source": "subtitle", "start": 0, "end": 500, "text": "Alice opens the door."},
                {"source": "ad", "start": 500, "end": 1000, "text": "A dark hallway is visible."},
            ],
        }]
    }
...
def test_intelligence_persists_validated_output_and_can_resume(tmp_path):
    ...
    def fake_infer(packet, model, base_url):
        ...
        return OllamaResult(
            model=model,
            response='{"summary":"Alice opens a door.","characters":["Alice"],"location":null,"actions":["opens the door"],"dialogue_points":[],"visual_description_points":["dark hallway"],"cause_effect":[],"importance":"normal","confidence":0.9,"unsupported_claims":[]}',
            parsed={
    ...
    # Intelligence requires ingestion, transcription, and timeline checkpoints.
