...
def _inputs(tmp_path):
    return {"final_video": tmp_path / "video" / "final.mp4", "narration": tmp_path / "audio" / "narration.wav", "script": tmp_path / "script" / "recap.txt", "timeline": tmp_path / "timeline.json", "intelligence": tmp_path / "intelligence" / "intelligence.json"}
